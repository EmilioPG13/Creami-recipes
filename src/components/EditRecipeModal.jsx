...
export default function EditRecipeModal({ recipe, onClose, onSave }) {
    const [formData, setFormData] = useState({
        title: recipe.title || '',
        base_flavor: recipe.base_flavor || '',
        scoop_mode: recipe.mode || 'both',
        program: recipe.program || 'ice-cream',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await onSave(recipe.id, recipeData);
            onClose();
        } catch (error) {
    ...
    return (
        <div className="fixed inset-0 z-[60] overflow-y-auto" aria-labelledby="edit-modal-title" role="dialog" aria-modal="true">
                ...
                <div className="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                    <div className="relative">
                        ...
                        <div className="p-6 sm:p-8 max-h-[90vh] overflow-y-auto">
                            <h2 id="edit-modal-title" className="font-heading text-3xl font-bold text-gray-800 mb-6">Edit Recipe</h2>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex gap-3 justify-end pt-4 border-t">
                                    ...
                                    <button
                                        ...
                                        className="px-6 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-bold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
