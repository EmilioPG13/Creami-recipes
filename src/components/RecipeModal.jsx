...
export default function RecipeModal({ recipe, onClose, onAddToShoppingList }) {
                    ...
                    <div className="relative">
                        ...
                        <div className="h-64 sm:h-80 w-full relative">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-6 sm:p-8">
                                <h2 className="font-heading text-3xl sm:text-4xl font-bold text-white mb-2">{recipe.title}</h2>
                                <div className="flex gap-3 text-white/90 text-sm font-medium">
                                    <span className="bg-white/20 backdrop-blur-md px-3 py-1 rounded-full">{recipe.calories} Calories</span>
                                    <span className="bg-white/20 backdrop-blur-md px-3 py-1 rounded-full">{recipe.protein} Protein</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <div>
                                    <h3 className="font-heading text-xl font-bold text-gray-800 mb-4 flex items-center">
                                        <span className="bg-pink-100 text-pink-500 p-1 rounded-lg mr-2"><ClipboardList className="w-5 h-5" /></span> Ingredients
                                    </h3>
                                ...
                                <div>
                                    <h3 className="font-heading text-xl font-bold text-gray-800 mb-4 flex items-center">
                                        <span className="bg-blue-100 text-blue-500 p-1 rounded-lg mr-2"><Settings className="w-5 h-5" /></span> Instructions
                                    </h3>
